 ...
 ******************************************************************************/
package net.iubris.kusor4diane;
...
import net.iubris.diane.searcher.locationaware.observatory.observable.KlocatorObservableSyncObservableDelegate;
...
public class KLocator4Diane extends KLocator implements Locator {

	private final KlocatorObservableSyncObservableDelegate syncObservableDelegate;

	@Inject
	public KLocator4Diane(Application context, 	LocatorSettings novodaLocatorSettings,
