 ...
 * 
 * KLocator_bak.java is part of 'Kusor'.
 * 
...
public class KLocator_bak implements IKLocator /* implements LocationObservable, LocationProvider, LocationUpdater */{
...
//	public KLocator(Application context, LocatorSettings novodaLocatorSettings/*, KlocatorObservableSyncObservableDelegate syncObservableDelegate*/) {
	public KLocator_bak(Context context, LocatorSettings novodaLocatorSettings/*, KlocatorObservableSyncObservableDelegate syncObservableDelegate*/) {
...
//Ln.d("NEW location: "+location);
			KLocator_bak.this.onNewLocation( location );
			//location = novodaLocator.getLocation();
			/*try {
